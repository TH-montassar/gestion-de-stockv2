			...
			<a class="dropdown-item d-flex align-items-center" href="#">
				<div class="dropdown-list-image mr-3">
					<img class="rounded-circle"
						src="<%=request.getContextPath()%>/resources/img/undraw_profile_1.svg"
						alt="...">
				...
				<div class="dropdown-list-image mr-3">
					<img class="rounded-circle"
						src="<%=request.getContextPath()%>/resources/img/undraw_profile_2.svg"
						alt="...">
				...
				<div class="dropdown-list-image mr-3">
					<img class="rounded-circle"
						src="<%=request.getContextPath()%>/resources/img/undraw_profile_3.svg"
						alt="...">
				...
				<div class="dropdown-list-image mr-3">
					<img class="rounded-circle"
						src="<%=request.getContextPath()%>/resources/https://source.unsplash.com/Mv9hjnEUHR4/60x60"
						alt="...">
					<div class="status-indicator bg-success"></div>
				</div>
				<div>
